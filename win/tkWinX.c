 ...
 * AppendTransChar --
 *
 *	Appends a character to the translated characters of the key event,
 *	encoded in UTF-8. The two halves of a surrogate pair are combined
 ...
 *
 * Side effects:
 *	Sets the trans_chars and nbytes members of the key event.
 *
 *----------------------------------------------------------------------
 */
