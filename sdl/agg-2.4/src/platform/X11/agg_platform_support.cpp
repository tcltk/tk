            ...
            switch(m_sys_format)            
            {
                ...
                case pix_format_rgb555:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565: color_conv(&rbuf_tmp, src, color_conv_bgr565_to_rgb555()); break;
                ...
                case pix_format_rgb565:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565: color_conv(&rbuf_tmp, src, color_conv_bgr565_to_rgb565()); break;
                ...
                case pix_format_bgr565:
                    ...
                    {
                        default: break;
                        case pix_format_rgb555: color_conv(&rbuf_tmp, src, color_conv_rgb555_to_bgr565()); break;
                        case pix_format_rgb565: color_conv(&rbuf_tmp, src, color_conv_rgb565_to_bgr565()); break;
                        case pix_format_bgr565: color_conv(&rbuf_tmp, src, color_conv_bgr565_to_bgr565()); break;
                        case pix_format_rgb24:  color_conv(&rbuf_tmp, src, color_conv_rgb24_to_bgr565());  break;
                        case pix_format_bgr24:  color_conv(&rbuf_tmp, src, color_conv_bgr24_to_bgr565());  break;
                        case pix_format_rgba32: color_conv(&rbuf_tmp, src, color_conv_rgba32_to_bgr565()); break;
                        case pix_format_argb32: color_conv(&rbuf_tmp, src, color_conv_argb32_to_bgr565()); break;
                        case pix_format_bgra32: color_conv(&rbuf_tmp, src, color_conv_bgra32_to_bgr565()); break;
                        case pix_format_abgr32: color_conv(&rbuf_tmp, src, color_conv_abgr32_to_bgr565()); break;
                    }
                    break;
                ...
                case pix_format_rgba32:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565:   color_conv(&rbuf_tmp, src, color_conv_bgr565_to_rgba32()); break;
                ...
                case pix_format_abgr32:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565: color_conv(&rbuf_tmp, src, color_conv_bgr565_to_abgr32()); break;
                ...
                case pix_format_argb32:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565: color_conv(&rbuf_tmp, src, color_conv_bgr565_to_argb32()); break;
                ...
                case pix_format_bgra32:
                    switch(m_format)
                    {
                        ...
                        case pix_format_bgr565:   color_conv(&rbuf_tmp, src, color_conv_bgr565_to_bgra32()); break;
...
//         }
        ...
        switch(m_specific->m_depth)
        {
            ...
            case 16:
                ...
                else if(r_mask == 0x1F && g_mask == 0x7E0 && b_mask == 0xF800)
                {
                    m_specific->m_sys_format = pix_format_bgr565;
                    m_specific->m_byte_order = hw_byte_order;
                }
                break;
        ...
        if(idx < max_images)
        {
            ...
            else
            {
                ...
                switch(m_format)
                {
                    ...
                    case pix_format_bgr565:
                        color_conv(m_rbuf_img+idx, &rbuf_img, color_conv_rgb24_to_bgr565());
                        break;
        ...
        if(idx < max_images &&  rbuf_img(idx).buf())
        {
            ...
            for(y = 0; y < rbuf_img(idx).height(); y++)
            {
                ...
                switch(m_format)
                {
                    ...
                    case pix_format_bgr565:
                        color_conv_row(tmp_buf, src, w, color_conv_bgr565_to_rgb24());
                        break;
