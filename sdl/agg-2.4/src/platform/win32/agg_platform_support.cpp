...
namespace agg
{
                             ...
                             pix_format_e format)
    {
        ...
        case pix_format_bgr565:
            color_conv(dst, src, color_conv_bgr565_to_rgb555());
            break;
                                      ...
                                      rendering_buffer* dst)
    {
        ...
        case pix_format_bgr565:
            switch(pmap_tmp.bpp())
            {
            case 16: color_conv(dst, &rbuf_tmp, color_conv_rgb555_to_bgr565()); break;
            case 24: color_conv(dst, &rbuf_tmp, color_conv_bgr24_to_bgr565()); break;
            case 32: color_conv(dst, &rbuf_tmp, color_conv_bgra32_to_bgr565()); break;
            }
            break;
