...
public:
    ...
    double textWidthU(const unsigned* str, int len);
    void   text(double x, double y, const char* str, bool roundOff=false, double dx=0.0, double dy=0.0);
    void   textU(double x, double y, const unsigned* str, int len, bool roundOff=false, double dx=0.0, double dy=0.0);
    ...
    void imageWrapMode(WrapMode f);
    WrapMode imageWrapMode() const;
