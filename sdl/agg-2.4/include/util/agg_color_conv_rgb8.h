...
namespace agg
{
    ...
    //-------------------------------------------------color_conv_bgr565_rgb24
    template<int R, int B> class color_conv_bgr565_rgb24
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
    ...
    //------------------------------------------------------------------------
    typedef color_conv_bgr565_rgb24<2,0> color_conv_bgr565_to_bgr24; //----color_conv_bgr565_to_bgr24
    typedef color_conv_bgr565_rgb24<0,2> color_conv_bgr565_to_rgb24; //----color_conv_bgr565_to_rgb24
    ...
    //-------------------------------------------------color_conv_rgb24_bgr565
    template<int R, int B> class color_conv_rgb24_bgr565
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
                          unsigned width) const
        {
            do
            {
                *(int16u*)dst = (int16u)(((unsigned(src[R]) >> 3))          |
                                         ((unsigned(src[1]) << 3) & 0x7E0)  |
                                         ((unsigned(src[B]) << 8) & 0xF800));
                src += 3;
                dst += 2;
            }
            while(--width);
    ...
    //------------------------------------------------------------------------
    typedef color_conv_rgb24_bgr565<2,0> color_conv_bgr24_to_bgr565; //----color_conv_bgr24_to_bgr565
    typedef color_conv_rgb24_bgr565<0,2> color_conv_rgb24_to_bgr565; //----color_conv_rgb24_to_bgr565
    ...
    //------------------------------------------------color_conv_bgr565_rgba32
    template<int R, int G, int B, int A> class color_conv_bgr565_rgba32
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
    ...
    //------------------------------------------------------------------------
    typedef color_conv_bgr565_rgba32<1,2,3,0> color_conv_bgr565_to_argb32; //----color_conv_rgb565_to_argb32
    typedef color_conv_bgr565_rgba32<3,2,1,0> color_conv_bgr565_to_abgr32; //----color_conv_rgb565_to_abgr32
    typedef color_conv_bgr565_rgba32<2,1,0,3> color_conv_bgr565_to_bgra32; //----color_conv_rgb565_to_bgra32
    typedef color_conv_bgr565_rgba32<0,1,2,3> color_conv_bgr565_to_rgba32; //----color_conv_rgb565_to_rgba32
    ...
    //------------------------------------------------color_conv_rgba32_bgr565
    template<int R, int G, int B> class color_conv_rgba32_bgr565
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
    ...
    //------------------------------------------------------------------------
    typedef color_conv_rgba32_bgr565<1,2,3> color_conv_argb32_to_bgr565; //----color_conv_argb32_to_bgr565
    typedef color_conv_rgba32_bgr565<3,2,1> color_conv_abgr32_to_bgr565; //----color_conv_abgr32_to_bgr565
    typedef color_conv_rgba32_bgr565<2,1,0> color_conv_bgra32_to_bgr565; //----color_conv_bgra32_to_bgr565
    typedef color_conv_rgba32_bgr565<0,1,2> color_conv_rgba32_to_bgr565; //----color_conv_rgba32_to_bgr565
    ...
    typedef color_conv_same<2> color_conv_bgr565_to_bgr565; //----color_conv_bgr565_to_bgr565


    //---------------------------------------------color_conv_rgb555_to_bgr565
    class color_conv_rgb555_to_bgr565
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
                          unsigned width) const
        {
            ...
            {
                unsigned rgb = *(int16u*)src;
		*(int16u*)dst = (int16u)((rgb >> 10) | ((rgb << 1) & 0x7E0) | (rgb << 11));
                src += 2;
                dst += 2;
            }
            while(--width);
    ...
    //----------------------------------------------color_conv_bgr565_to_rgb555
    class color_conv_bgr565_to_rgb555
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
                          unsigned width) const
        {
            ...
            {
                unsigned rgb = *(int16u*)src;
		*(int16u*)dst = (int16u)(((rgb << 10) & 0x7C00) | ((rgb >> 1) & 0x3E0) | (rgb >> 11));
                src += 2;
                dst += 2;
            }
            while(--width);
    ...
    //----------------------------------------------color_conv_bgr565_to_rgb565
    class color_conv_bgr565_to_rgb565
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
                          unsigned width) const
        {
            ...
            {
                unsigned rgb = *(int16u*)src;
		*(int16u*)dst = (int16u)(((rgb << 11) & 0xF800) | (rgb & 0x7E0) | (rgb >> 11));
                src += 2;
                dst += 2;
            }
            while(--width);
    ...
    //----------------------------------------------color_conv_rgb565_to_bgr565
    class color_conv_rgb565_to_bgr565
    {
    public:
        void operator () (int8u* dst,
                          const int8u* src,
