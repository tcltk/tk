...
/* XPM */
static const char *const button_images_large[] = {
...
/* XPM */
static const char *const button_images_small[] = {
    /* width height ncolors chars_per_pixel */
    "52 26 7 1",
    /* colors */
    "A c #808000000000",
...
typedef struct {
    int check_button_dim;
    int check_menu_dim;
    int check_start;
    int check_on_offset;
    int check_off_offset;
    int check_dison_offset;
    int check_disoff_offset;
    int check_start_yoffset;
    int check_start_xoffset;
    int radio_button_dim;
    int radio_menu_dim;
    int radio_width;
    int radio_start;
    int radio_on_offset;
    int radio_off_offset;
    int radio_dison_offset;
    int radio_disoff_offset;
    int radio_start_yoffset;
    int radio_start_xoffset;
} image_dimensions;

static const image_dimensions img_dim_large = {
    23, 15, 9, 23, 0, 69, 46, 4, 4,
    23, 9, 23, 32, 23, 0, 69, 46, 7, 7,
};

static const image_dimensions img_dim_small = {
    13, 9, 9, 13, 0, 39, 26, 2, 2,
    12, 6, 13, 22, 13, 0, 39, 26, 3, 3,
};

#define CHECK_BUTTON_DIM    img_dim->check_button_dim
#define CHECK_MENU_DIM      img_dim->check_menu_dim
#define CHECK_START         img_dim->check_start
#define CHECK_ON_OFFSET     img_dim->check_on_offset
#define CHECK_OFF_OFFSET    img_dim->check_off_offset
#define CHECK_DISON_OFFSET  img_dim->check_dison_offset
#define CHECK_DISOFF_OFFSET img_dim->check_disoff_offset
#define CHECK_START_YOFFSET img_dim->check_start_yoffset
#define CHECK_START_XOFFSET img_dim->check_start_xoffset
#define RADIO_BUTTON_DIM    img_dim->radio_button_dim
#define RADIO_MENU_DIM      img_dim->radio_menu_dim
#define RADIO_WIDTH         img_dim->radio_width
#define RADIO_START         img_dim->radio_start
#define RADIO_ON_OFFSET     img_dim->radio_on_offset
#define RADIO_OFF_OFFSET    img_dim->radio_off_offset
#define RADIO_DISON_OFFSET  img_dim->radio_dison_offset
#define RADIO_DISOFF_OFFSET img_dim->radio_disoff_offset
#define RADIO_START_YOFFSET img_dim->radio_start_yoffset
#define RADIO_START_XOFFSET img_dim->radio_start_xoffset
    ...
    int mode)			/* kind of indicator to draw */
{
    ...
    const image_dimensions *img_dim;
	...
	button_images = button_images_large;
	img_dim = &img_dim_large;
    }
