 ...
 * coordinate system (Retina displays).  TkpPutRGBAImageScaled lets
 * tkImgPhInstance.c draw a photo image whose -density is not 1 without
 * resampling it first: image pixels are mapped onto the backing store by
 * Core Graphics.
 */
