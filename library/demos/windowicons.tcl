...
pack [button .i -text "Set Window Icon to Globe" -image $::tk::icons::base_icon -compound top -command {wm iconphoto . $::tk::icons::base_icon }]
pack [button .b -text "Set Badge to 3" -command {wm iconbadge . 3}]
pack [button .e -text "Set Badge to 11" -command {wm iconbadge . 11}]
pack [button .f -text "Reset Badge" -command {wm iconbadge . ""}]
