 ...
 * tkUnicodeKeysyms.h --
 *
 *	Table pairing the X11 keysyms of alphanumeric characters with their
 *	Unicode code points, used to translate between the two on platforms
 *	which do not provide keysyms (macOS and Windows).
 *
...
#ifndef TKUNICODEKEYSYMS_H
#define TKUNICODEKEYSYMS_H 1
...
typedef struct KeysymInfo {
    ...
    int unichar;		/* Unicode code point */
} KeysymInfo;
...
static const KeysymInfo keysymTable[] = {
    ...
    {0x10020a0, 0x20a0}, /* EcuSign */
    {0x10020a1, 0x20a1}, /* ColonSign */
    {0x10020a2, 0x20a2}, /* CruzeiroSign */
    {0x10020a3, 0x20a3}, /* FFrancSign */
    {0x10020a4, 0x20a4}, /* LiraSign */
    {0x10020a5, 0x20a5}, /* MillSign */
    {0x10020a6, 0x20a6}, /* NairaSign */
    {0x10020a7, 0x20a7}, /* PesetaSign */
    {0x10020a8, 0x20a8}, /* RupeeSign */
    {0x10020a9, 0x20a9}, /* WonSign */
    {0x10020aa, 0x20aa}, /* NewSheqelSign */
    {0x10020ab, 0x20ab}, /* DongSign */
    {0x20ac, 0x20ac}, /* EuroSign */
    {0x06ad, 0x0491}, /* Ukrainian_ghe_with_upturn */
    {0x06bd, 0x0490}, /* Ukrainian_GHE_WITH_UPTURN */
    {0x1000587, 0x0587}, /* Armenian_ligature_ew */
    {0x1000589, 0x0589}, /* Armenian_verjaket */
    {0x100055d, 0x055d}, /* Armenian_but */
    {0x100058a, 0x058a}, /* Armenian_yentamna */
    {0x100055c, 0x055c}, /* Armenian_amanak */
    {0x100055b, 0x055b}, /* Armenian_shesht */
    {0x100055e, 0x055e}, /* Armenian_paruyk */
    {0x1000531, 0x0531}, /* Armenian_AYB */
    {0x1000561, 0x0561}, /* Armenian_ayb */
    {0x1000532, 0x0532}, /* Armenian_BEN */
    {0x1000562, 0x0562}, /* Armenian_ben */
    {0x1000533, 0x0533}, /* Armenian_GIM */
    {0x1000563, 0x0563}, /* Armenian_gim */
    {0x1000534, 0x0534}, /* Armenian_DA */
    {0x1000564, 0x0564}, /* Armenian_da */
    {0x1000535, 0x0535}, /* Armenian_YECH */
    {0x1000565, 0x0565}, /* Armenian_yech */
    {0x1000536, 0x0536}, /* Armenian_ZA */
    {0x1000566, 0x0566}, /* Armenian_za */
    {0x1000537, 0x0537}, /* Armenian_E */
    {0x1000567, 0x0567}, /* Armenian_e */
    {0x1000538, 0x0538}, /* Armenian_AT */
    {0x1000568, 0x0568}, /* Armenian_at */
    {0x1000539, 0x0539}, /* Armenian_TO */
    {0x1000569, 0x0569}, /* Armenian_to */
    {0x100053a, 0x053a}, /* Armenian_ZHE */
    {0x100056a, 0x056a}, /* Armenian_zhe */
    {0x100053b, 0x053b}, /* Armenian_INI */
    {0x100056b, 0x056b}, /* Armenian_ini */
    {0x100053c, 0x053c}, /* Armenian_LYUN */
    {0x100056c, 0x056c}, /* Armenian_lyun */
    {0x100053d, 0x053d}, /* Armenian_KHE */
    {0x100056d, 0x056d}, /* Armenian_khe */
    {0x100053e, 0x053e}, /* Armenian_TSA */
    {0x100056e, 0x056e}, /* Armenian_tsa */
    {0x100053f, 0x053f}, /* Armenian_KEN */
    {0x100056f, 0x056f}, /* Armenian_ken */
    {0x1000540, 0x0540}, /* Armenian_HO */
    {0x1000570, 0x0570}, /* Armenian_ho */
    {0x1000541, 0x0541}, /* Armenian_DZA */
    {0x1000571, 0x0571}, /* Armenian_dza */
    {0x1000542, 0x0542}, /* Armenian_GHAT */
    {0x1000572, 0x0572}, /* Armenian_ghat */
    {0x1000543, 0x0543}, /* Armenian_TCHE */
    {0x1000573, 0x0573}, /* Armenian_tche */
    {0x1000544, 0x0544}, /* Armenian_MEN */
    {0x1000574, 0x0574}, /* Armenian_men */
    {0x1000545, 0x0545}, /* Armenian_HI */
    {0x1000575, 0x0575}, /* Armenian_hi */
    {0x1000546, 0x0546}, /* Armenian_NU */
    {0x1000576, 0x0576}, /* Armenian_nu */
    {0x1000547, 0x0547}, /* Armenian_SHA */
    {0x1000577, 0x0577}, /* Armenian_sha */
    {0x1000548, 0x0548}, /* Armenian_VO */
    {0x1000578, 0x0578}, /* Armenian_vo */
    {0x1000549, 0x0549}, /* Armenian_CHA */
    {0x1000579, 0x0579}, /* Armenian_cha */
    {0x100054a, 0x054a}, /* Armenian_PE */
    {0x100057a, 0x057a}, /* Armenian_pe */
    {0x100054b, 0x054b}, /* Armenian_JE */
    {0x100057b, 0x057b}, /* Armenian_je */
    {0x100054c, 0x054c}, /* Armenian_RA */
    {0x100057c, 0x057c}, /* Armenian_ra */
    {0x100054d, 0x054d}, /* Armenian_SE */
    {0x100057d, 0x057d}, /* Armenian_se */
    {0x100054e, 0x054e}, /* Armenian_VEV */
    {0x100057e, 0x057e}, /* Armenian_vev */
    {0x100054f, 0x054f}, /* Armenian_TYUN */
    {0x100057f, 0x057f}, /* Armenian_tyun */
    {0x1000550, 0x0550}, /* Armenian_RE */
    {0x1000580, 0x0580}, /* Armenian_re */
    {0x1000551, 0x0551}, /* Armenian_TSO */
    {0x1000581, 0x0581}, /* Armenian_tso */
    {0x1000552, 0x0552}, /* Armenian_VYUN */
    {0x1000582, 0x0582}, /* Armenian_vyun */
    {0x1000553, 0x0553}, /* Armenian_PYUR */
    {0x1000583, 0x0583}, /* Armenian_pyur */
    {0x1000554, 0x0554}, /* Armenian_KE */
    {0x1000584, 0x0584}, /* Armenian_ke */
    {0x1000555, 0x0555}, /* Armenian_O */
    {0x1000585, 0x0585}, /* Armenian_o */
    {0x1000556, 0x0556}, /* Armenian_FE */
    {0x1000586, 0x0586}, /* Armenian_fe */
    {0x100055a, 0x055a}, /* Armenian_apostrophe */
    {0x10010d0, 0x10d0}, /* Georgian_an */
    {0x10010d1, 0x10d1}, /* Georgian_ban */
    {0x10010d2, 0x10d2}, /* Georgian_gan */
    {0x10010d3, 0x10d3}, /* Georgian_don */
    {0x10010d4, 0x10d4}, /* Georgian_en */
    {0x10010d5, 0x10d5}, /* Georgian_vin */
    {0x10010d6, 0x10d6}, /* Georgian_zen */
    {0x10010d7, 0x10d7}, /* Georgian_tan */
    {0x10010d8, 0x10d8}, /* Georgian_in */
    {0x10010d9, 0x10d9}, /* Georgian_kan */
    {0x10010da, 0x10da}, /* Georgian_las */
    {0x10010db, 0x10db}, /* Georgian_man */
    {0x10010dc, 0x10dc}, /* Georgian_nar */
    {0x10010dd, 0x10dd}, /* Georgian_on */
    {0x10010de, 0x10de}, /* Georgian_par */
    {0x10010df, 0x10df}, /* Georgian_zhar */
    {0x10010e0, 0x10e0}, /* Georgian_rae */
    {0x10010e1, 0x10e1}, /* Georgian_san */
    {0x10010e2, 0x10e2}, /* Georgian_tar */
    {0x10010e3, 0x10e3}, /* Georgian_un */
    {0x10010e4, 0x10e4}, /* Georgian_phar */
    {0x10010e5, 0x10e5}, /* Georgian_khar */
    {0x10010e6, 0x10e6}, /* Georgian_ghan */
    {0x10010e7, 0x10e7}, /* Georgian_qar */
    {0x10010e8, 0x10e8}, /* Georgian_shin */
    {0x10010e9, 0x10e9}, /* Georgian_chin */
    {0x10010ea, 0x10ea}, /* Georgian_can */
    {0x10010eb, 0x10eb}, /* Georgian_jil */
    {0x10010ec, 0x10ec}, /* Georgian_cil */
    {0x10010ed, 0x10ed}, /* Georgian_char */
    {0x10010ee, 0x10ee}, /* Georgian_xan */
    {0x10010ef, 0x10ef}, /* Georgian_jhan */
    {0x10010f0, 0x10f0}, /* Georgian_hae */
    {0x10010f1, 0x10f1}, /* Georgian_he */
    {0x10010f2, 0x10f2}, /* Georgian_hie */
    {0x10010f3, 0x10f3}, /* Georgian_we */
    {0x10010f4, 0x10f4}, /* Georgian_har */
    {0x10010f5, 0x10f5}, /* Georgian_hoe */
    {0x10010f6, 0x10f6}, /* Georgian_fi */
    {0x1001e02, 0x1e02}, /* Babovedot */
    {0x1001e03, 0x1e03}, /* babovedot */
    {0x1001e0a, 0x1e0a}, /* Dabovedot */
    {0x1001e80, 0x1e80}, /* Wgrave */
    {0x1001e82, 0x1e82}, /* Wacute */
    {0x1001e0b, 0x1e0b}, /* dabovedot */
    {0x1001ef2, 0x1ef2}, /* Ygrave */
    {0x1001e1e, 0x1e1e}, /* Fabovedot */
    {0x1001e1f, 0x1e1f}, /* fabovedot */
    {0x1001e40, 0x1e40}, /* Mabovedot */
    {0x1001e41, 0x1e41}, /* mabovedot */
    {0x1001e56, 0x1e56}, /* Pabovedot */
    {0x1001e81, 0x1e81}, /* wgrave */
    {0x1001e57, 0x1e57}, /* pabovedot */
    {0x1001e83, 0x1e83}, /* wacute */
    {0x1001e60, 0x1e60}, /* Sabovedot */
    {0x1001ef3, 0x1ef3}, /* ygrave */
    {0x1001e84, 0x1e84}, /* Wdiaeresis */
    {0x1001e85, 0x1e85}, /* wdiaeresis */
    {0x1001e61, 0x1e61}, /* sabovedot */
    {0x1000174, 0x0174}, /* Wcircumflex */
    {0x1001e6a, 0x1e6a}, /* Tabovedot */
    {0x1000176, 0x0176}, /* Ycircumflex */
    {0x1000175, 0x0175}, /* wcircumflex */
    {0x1001e6b, 0x1e6b}, /* tabovedot */
    {0x1000177, 0x0177}, /* ycircumflex */
    {0x10006f0, 0x06f0}, /* Farsi_0 */
    {0x10006f1, 0x06f1}, /* Farsi_1 */
    {0x10006f2, 0x06f2}, /* Farsi_2 */
    {0x10006f3, 0x06f3}, /* Farsi_3 */
    {0x10006f4, 0x06f4}, /* Farsi_4 */
    {0x10006f5, 0x06f5}, /* Farsi_5 */
    {0x10006f6, 0x06f6}, /* Farsi_6 */
    {0x10006f7, 0x06f7}, /* Farsi_7 */
    {0x10006f8, 0x06f8}, /* Farsi_8 */
    {0x10006f9, 0x06f9}, /* Farsi_9 */
    {0x100066a, 0x066a}, /* Arabic_percent */
    {0x1000670, 0x0670}, /* Arabic_superscript_alef */
    {0x1000679, 0x0679}, /* Arabic_tteh */
    {0x100067e, 0x067e}, /* Arabic_peh */
    {0x1000686, 0x0686}, /* Arabic_tcheh */
    {0x1000688, 0x0688}, /* Arabic_ddal */
    {0x1000691, 0x0691}, /* Arabic_rreh */
    {0x10006d4, 0x06d4}, /* Arabic_fullstop */
    {0x1000660, 0x0660}, /* Arabic_0 */
    {0x1000661, 0x0661}, /* Arabic_1 */
    {0x1000662, 0x0662}, /* Arabic_2 */
    {0x1000663, 0x0663}, /* Arabic_3 */
    {0x1000664, 0x0664}, /* Arabic_4 */
    {0x1000665, 0x0665}, /* Arabic_5 */
    {0x1000666, 0x0666}, /* Arabic_6 */
    {0x1000667, 0x0667}, /* Arabic_7 */
    {0x1000668, 0x0668}, /* Arabic_8 */
    {0x1000669, 0x0669}, /* Arabic_9 */
    {0x1000653, 0x0653}, /* Arabic_madda_above */
    {0x1000654, 0x0654}, /* Arabic_hamza_above */
    {0x1000655, 0x0655}, /* Arabic_hamza_below */
    {0x1000698, 0x0698}, /* Arabic_jeh */
    {0x10006a4, 0x06a4}, /* Arabic_veh */
    {0x10006a9, 0x06a9}, /* Arabic_keheh */
    {0x10006af, 0x06af}, /* Arabic_gaf */
    {0x10006ba, 0x06ba}, /* Arabic_noon_ghunna */
    {0x10006be, 0x06be}, /* Arabic_heh_doachashmee */
    {0x10006cc, 0x06cc}, /* Farsi_yeh */
    {0x10006d2, 0x06d2}, /* Arabic_yeh_baree */
    {0x10006c1, 0x06c1}, /* Arabic_heh_goal */
    {0x1000492, 0x0492}, /* Cyrillic_GHE_bar */
    {0x1000496, 0x0496}, /* Cyrillic_ZHE_descender */
    {0x100049a, 0x049a}, /* Cyrillic_KA_descender */
    {0x100049c, 0x049c}, /* Cyrillic_KA_vertstroke */
    {0x10004a2, 0x04a2}, /* Cyrillic_EN_descender */
    {0x10004ae, 0x04ae}, /* Cyrillic_U_straight */
    {0x10004b0, 0x04b0}, /* Cyrillic_U_straight_bar */
    {0x10004b2, 0x04b2}, /* Cyrillic_HA_descender */
    {0x10004b6, 0x04b6}, /* Cyrillic_CHE_descender */
    {0x10004b8, 0x04b8}, /* Cyrillic_CHE_vertstroke */
    {0x10004ba, 0x04ba}, /* Cyrillic_SHHA */
    {0x10004d8, 0x04d8}, /* Cyrillic_SCHWA */
    {0x10004e2, 0x04e2}, /* Cyrillic_I_macron */
    {0x10004e8, 0x04e8}, /* Cyrillic_O_bar */
    {0x10004ee, 0x04ee}, /* Cyrillic_U_macron */
    {0x1000493, 0x0493}, /* Cyrillic_ghe_bar */
    {0x1000497, 0x0497}, /* Cyrillic_zhe_descender */
    {0x100049b, 0x049b}, /* Cyrillic_ka_descender */
    {0x100049d, 0x049d}, /* Cyrillic_ka_vertstroke */
    {0x10004a3, 0x04a3}, /* Cyrillic_en_descender */
    {0x10004af, 0x04af}, /* Cyrillic_u_straight */
    {0x10004b1, 0x04b1}, /* Cyrillic_u_straight_bar */
    {0x10004b3, 0x04b3}, /* Cyrillic_ha_descender */
    {0x10004b7, 0x04b7}, /* Cyrillic_che_descender */
    {0x10004b9, 0x04b9}, /* Cyrillic_che_vertstroke */
    {0x10004bb, 0x04bb}, /* Cyrillic_shha */
    {0x10004d9, 0x04d9}, /* Cyrillic_schwa */
    {0x10004e3, 0x04e3}, /* Cyrillic_i_macron */
    {0x10004e9, 0x04e9}, /* Cyrillic_o_bar */
    {0x10004ef, 0x04ef}, /* Cyrillic_u_macron */
    {0x1001e8a, 0x1e8a}, /* Xabovedot */
    {0x100012c, 0x012c}, /* Ibreve */
    {0x10001b5, 0x01b5}, /* Zstroke */
    {0x10001e6, 0x01e6}, /* Gcaron */
    {0x100019f, 0x019f}, /* Obarred */
    {0x1001e8b, 0x1e8b}, /* xabovedot */
    {0x100012d, 0x012d}, /* ibreve */
    {0x10001b6, 0x01b6}, /* zstroke */
    {0x10001e7, 0x01e7}, /* gcaron */
    {0x10001d2, 0x01d2}, /* ocaron */
    {0x1000275, 0x0275}, /* obarred */
    {0x100018f, 0x018f}, /* SCHWA */
    {0x1000259, 0x0259}, /* schwa */
    {0x1001e36, 0x1e36}, /* Lbelowdot */
    {0x1001e37, 0x1e37}, /* lbelowdot */
    {0x1001ea0, 0x1ea0}, /* Abelowdot */
    {0x1001ea1, 0x1ea1}, /* abelowdot */
    {0x1001ea2, 0x1ea2}, /* Ahook */
    {0x1001ea3, 0x1ea3}, /* ahook */
    {0x1001ea4, 0x1ea4}, /* Acircumflexacute */
    {0x1001ea5, 0x1ea5}, /* acircumflexacute */
    {0x1001ea6, 0x1ea6}, /* Acircumflexgrave */
    {0x1001ea7, 0x1ea7}, /* acircumflexgrave */
    {0x1001ea8, 0x1ea8}, /* Acircumflexhook */
    {0x1001ea9, 0x1ea9}, /* acircumflexhook */
    {0x1001eaa, 0x1eaa}, /* Acircumflextilde */
    {0x1001eab, 0x1eab}, /* acircumflextilde */
    {0x1001eac, 0x1eac}, /* Acircumflexbelowdot */
    {0x1001ead, 0x1ead}, /* acircumflexbelowdot */
    {0x1001eae, 0x1eae}, /* Abreveacute */
    {0x1001eaf, 0x1eaf}, /* abreveacute */
    {0x1001eb0, 0x1eb0}, /* Abrevegrave */
    {0x1001eb1, 0x1eb1}, /* abrevegrave */
    {0x1001eb2, 0x1eb2}, /* Abrevehook */
    {0x1001eb3, 0x1eb3}, /* abrevehook */
    {0x1001eb4, 0x1eb4}, /* Abrevetilde */
    {0x1001eb5, 0x1eb5}, /* abrevetilde */
    {0x1001eb6, 0x1eb6}, /* Abrevebelowdot */
    {0x1001eb7, 0x1eb7}, /* abrevebelowdot */
    {0x1001eb8, 0x1eb8}, /* Ebelowdot */
    {0x1001eb9, 0x1eb9}, /* ebelowdot */
    {0x1001eba, 0x1eba}, /* Ehook */
    {0x1001ebb, 0x1ebb}, /* ehook */
    {0x1001ebc, 0x1ebc}, /* Etilde */
    {0x1001ebd, 0x1ebd}, /* etilde */
    {0x1001ebe, 0x1ebe}, /* Ecircumflexacute */
    {0x1001ebf, 0x1ebf}, /* ecircumflexacute */
    {0x1001ec0, 0x1ec0}, /* Ecircumflexgrave */
    {0x1001ec1, 0x1ec1}, /* ecircumflexgrave */
    {0x1001ec2, 0x1ec2}, /* Ecircumflexhook */
    {0x1001ec3, 0x1ec3}, /* ecircumflexhook */
    {0x1001ec4, 0x1ec4}, /* Ecircumflextilde */
    {0x1001ec5, 0x1ec5}, /* ecircumflextilde */
    {0x1001ec6, 0x1ec6}, /* Ecircumflexbelowdot */
    {0x1001ec7, 0x1ec7}, /* ecircumflexbelowdot */
    {0x1001ec8, 0x1ec8}, /* Ihook */
    {0x1001ec9, 0x1ec9}, /* ihook */
    {0x1001eca, 0x1eca}, /* Ibelowdot */
    {0x1001ecb, 0x1ecb}, /* ibelowdot */
    {0x1001ecc, 0x1ecc}, /* Obelowdot */
    {0x1001ecd, 0x1ecd}, /* obelowdot */
    {0x1001ece, 0x1ece}, /* Ohook */
    {0x1001ecf, 0x1ecf}, /* ohook */
    {0x1001ed0, 0x1ed0}, /* Ocircumflexacute */
    {0x1001ed1, 0x1ed1}, /* ocircumflexacute */
    {0x1001ed2, 0x1ed2}, /* Ocircumflexgrave */
    {0x1001ed3, 0x1ed3}, /* ocircumflexgrave */
    {0x1001ed4, 0x1ed4}, /* Ocircumflexhook */
    {0x1001ed5, 0x1ed5}, /* ocircumflexhook */
    {0x1001ed6, 0x1ed6}, /* Ocircumflextilde */
    {0x1001ed7, 0x1ed7}, /* ocircumflextilde */
    {0x1001ed8, 0x1ed8}, /* Ocircumflexbelowdot */
    {0x1001ed9, 0x1ed9}, /* ocircumflexbelowdot */
    {0x1001eda, 0x1eda}, /* Ohornacute */
    {0x1001edb, 0x1edb}, /* ohornacute */
    {0x1001edc, 0x1edc}, /* Ohorngrave */
    {0x1001edd, 0x1edd}, /* ohorngrave */
    {0x1001ede, 0x1ede}, /* Ohornhook */
    {0x1001edf, 0x1edf}, /* ohornhook */
    {0x1001ee0, 0x1ee0}, /* Ohorntilde */
    {0x1001ee1, 0x1ee1}, /* ohorntilde */
    {0x1001ee2, 0x1ee2}, /* Ohornbelowdot */
    {0x1001ee3, 0x1ee3}, /* ohornbelowdot */
    {0x1001ee4, 0x1ee4}, /* Ubelowdot */
    {0x1001ee5, 0x1ee5}, /* ubelowdot */
    {0x1001ee6, 0x1ee6}, /* Uhook */
    {0x1001ee7, 0x1ee7}, /* uhook */
    {0x1001ee8, 0x1ee8}, /* Uhornacute */
    {0x1001ee9, 0x1ee9}, /* uhornacute */
    {0x1001eea, 0x1eea}, /* Uhorngrave */
    {0x1001eeb, 0x1eeb}, /* uhorngrave */
    {0x1001eec, 0x1eec}, /* Uhornhook */
    {0x1001eed, 0x1eed}, /* uhornhook */
    {0x1001eee, 0x1eee}, /* Uhorntilde */
    {0x1001eef, 0x1eef}, /* uhorntilde */
    {0x1001ef0, 0x1ef0}, /* Uhornbelowdot */
    {0x1001ef1, 0x1ef1}, /* uhornbelowdot */
    {0x1001ef4, 0x1ef4}, /* Ybelowdot */
    {0x1001ef5, 0x1ef5}, /* ybelowdot */
    {0x1001ef6, 0x1ef6}, /* Yhook */
    {0x1001ef7, 0x1ef7}, /* yhook */
    {0x1001ef8, 0x1ef8}, /* Ytilde */
    {0x1001ef9, 0x1ef9}, /* ytilde */
    {0x10001a0, 0x01a0}, /* Ohorn */
    {0x10001a1, 0x01a1}, /* ohorn */
    {0x10001af, 0x01af}, /* Uhorn */
    {0x10001b0, 0x01b0}, /* uhorn */
    {0, 0}
};

#endif /* TKUNICODEKEYSYMS_H */
