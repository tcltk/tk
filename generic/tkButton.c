...
static const Tk_OptionSpec labelOptionSpecs[] = {
	...
	DEF_LABCHKRAD_RELIEF, TCL_INDEX_NONE, offsetof(TkButton, relief), TK_OPTION_ENUM_VAR, 0, 0},
...
static const Tk_OptionSpec checkbuttonOptionSpecs[] = {
    ...
    {TK_OPTION_RELIEF, "-offrelief", "offRelief", "OffRelief",
	 DEF_BUTTON_RELIEF, TCL_INDEX_NONE, offsetof(TkButton, offRelief), TK_OPTION_ENUM_VAR, 0, 0},
