...
static const Tk_OptionSpec entryOptSpec[] = {
	...
	DEF_ENTRY_BORDER_WIDTH, offsetof(Entry, borderWidthPtr), offsetof(Entry, borderWidth), 0, 0, 0},
	...
	"HighlightThickness", DEF_ENTRY_HIGHLIGHT_WIDTH, offsetof(Entry, highlightWidthPtr),
	...
	"BorderWidth", DEF_ENTRY_INSERT_BD_COLOR, offsetof(Entry, insertBorderWidthPtr),
	...
	DEF_ENTRY_INSERT_WIDTH, offsetof(Entry, insertWidthPtr), offsetof(Entry, insertWidth), 0, 0, 0},
	...
	"BorderWidth", DEF_ENTRY_SELECT_BD_COLOR, offsetof(Entry, selBorderWidthPtr),
