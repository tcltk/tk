...
static const Tk_OptionSpec entryOptSpec[] = {
	...
	offsetof(Entry, exportSelection), TK_OPTION_BOOL_VAR, 0, 0},
	...
	DEF_ENTRY_RELIEF, TCL_INDEX_NONE, offsetof(Entry, relief), TK_OPTION_ENUM_VAR, 0, 0},
...
static const Tk_OptionSpec sbOptSpec[] = {
	...
	DEF_BUTTON_RELIEF, TCL_INDEX_NONE, offsetof(Spinbox, bdRelief), TK_OPTION_ENUM_VAR, 0, 0},
    {TK_OPTION_RELIEF, "-buttonuprelief", "buttonUpRelief", "Relief",
	DEF_BUTTON_RELIEF, TCL_INDEX_NONE, offsetof(Spinbox, buRelief), TK_OPTION_ENUM_VAR, 0, 0},
	...
	DEF_SPINBOX_WRAP, TCL_INDEX_NONE, offsetof(Spinbox, wrap), TK_OPTION_BOOL_VAR, 0, 0},
    {TK_OPTION_STRING, "-xscrollcommand", "xScrollCommand", "ScrollCommand",
	DEF_ENTRY_SCROLL_COMMAND, TCL_INDEX_NONE, offsetof(Entry, scrollCmd),
	TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_END, NULL, NULL, NULL, NULL, 0, TCL_INDEX_NONE, 0, 0, 0}
