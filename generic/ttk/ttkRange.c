/*
 * Copyright © 2011 Goodwin Lawlor goodwin.lawlor@gmail.com
 *
 * ttk::range widget.
 */
...
static Tk_OptionSpec RangeOptionSpecs[] =
{
	...
	offsetof(Range,range.commandObj), -1,
	TK_OPTION_NULL_OK,0,0},
    {TK_OPTION_STRING, "-minvariable", "minvariable", "Minvariable", "",
	offsetof(Range,range.minvariableObj), -1,
	0,0,0},
    {TK_OPTION_STRING, "-maxvariable", "maxvariable", "Maxvariable", "",
	offsetof(Range,range.maxvariableObj), -1,
	0,0,0},
    {TK_OPTION_STRING_TABLE, "-orient", "orient", "Orient", "horizontal",
	offsetof(Range,range.orientObj),
	offsetof(Range,range.orient), 0,
	(ClientData)ttkOrientStrings, STYLE_CHANGED },

    {TK_OPTION_DOUBLE, "-from", "from", "From", "0",
	offsetof(Range,range.fromObj), -1, 0, 0, 0},
    {TK_OPTION_DOUBLE, "-to", "to", "To", "1.0",
	offsetof(Range,range.toObj), -1, 0, 0, 0},
    {TK_OPTION_DOUBLE, "-minvalue", "minvalue", "Minvalue", "0",
	offsetof(Range,range.minvalueObj), -1, 0, 0, 0},
    {TK_OPTION_DOUBLE, "-maxvalue", "maxvalue", "Maxvalue", "1.0",
	offsetof(Range,range.maxvalueObj), -1, 0, 0, 0},
    {TK_OPTION_PIXELS, "-length", "length", "Length",
	DEF_RANGE_LENGTH, offsetof(Range,range.lengthObj), -1, 0, 0,
    	GEOMETRY_CHANGED},
