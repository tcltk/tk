...
static void
PackLostContentProc(
    ClientData clientData,	/* Packer structure for content window that was
				 * stolen away. */
    Tk_Window tkwin)		/* Tk's handle for the content window. */
{
    register Packer *contentPtr = clientData;
				 ...
				 * are to be re-layed out. */
{
     ...
     * just leave the container's size as-is.
     */
...
static int
XExpansion(
    register Packer *contentPtr,	/* First in list of remaining content. */
    ...
    XEvent *eventPtr)		/* Describes what just happened. */
{
	...
	register Packer *contentPtr, *nextPtr;
