...
/* lao - 30550 words from laodict.txt. */
const char* const lao_words[] = {
    "ກໍ",
    "ກໍ່",
    "ກໍ້",
    "ກໍ່ກວນ",
...
const size_t lao_word_count = 30550;

/* Combined language struct for lao. */
const LanguageDict lao_dict = {
    lao_words,            /* words */
    30550,                /* count  – hard-coded */
    "lao",                /* language */
    "lo"                  /* code */
};