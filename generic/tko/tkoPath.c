...
static tkoWidgetOptionDefine pathOptionDefine[] = {
    {"-class", "class", "Class",
            "TkoPath", NULL, NULL, TKO_WIDGETOPTIONREADONLY,
        TKO_SET_CLASS, NULL, 0},
    {"-background", "background", "Background",
            DEF_CANVAS_BG_COLOR, NULL, NULL, 0,
        TKO_SET_3DBORDER, &pathMeta, offsetof(TkPathCanvas, bgBorder)},
    {"-bd", "-borderwidth", NULL, NULL, NULL, NULL, 0,
        0, NULL, 0},
    {"-bg", "-background", NULL, NULL, NULL, NULL, 0,
        0, NULL, 0},
    {"-borderwidth", "borderWidth", "BorderWidth",
            DEF_CANVAS_BORDER_WIDTH, NULL, NULL, 0,
        TKO_SET_PIXELNONEGATIV, &pathMeta, offsetof(TkPathCanvas,
                borderWidth)},
    {"-closeenough", "closeEnough", "CloseEnough",
            DEF_CANVAS_CLOSE_ENOUGH, NULL, NULL, 0,
        TKO_SET_DOUBLE, &pathMeta, offsetof(TkPathCanvas, closeEnough)},
    {"-confine", "confine", "Confine",
            DEF_CANVAS_CONFINE, NULL, NULL, 0,
        TKO_SET_BOOLEAN, &pathMeta, offsetof(TkPathCanvas, confine)},
    {"-cursor", "cursor", "Cursor",
            DEF_CANVAS_CURSOR, NULL, NULL, 0,
        TKO_SET_CURSOR, &pathMeta, offsetof(TkPathCanvas, cursor)},
    {"-height", "height", "Height",
            DEF_CANVAS_HEIGHT, NULL, NULL, 0,
        TKO_SET_PIXEL, &pathMeta, offsetof(TkPathCanvas, height)},
    {"-highlightbackground", "highlightBackground", "HighlightBackground",
            DEF_CANVAS_HIGHLIGHT_BG, NULL, NULL, 0,
        TKO_SET_XCOLOR, &pathMeta, offsetof(TkPathCanvas,
                highlightBgColorPtr)},
    {"-highlightcolor", "highlightColor", "HighlightColor",
            DEF_CANVAS_HIGHLIGHT, NULL, NULL, 0,
        TKO_SET_XCOLOR, &pathMeta, offsetof(TkPathCanvas, highlightColorPtr)},
    {"-highlightthickness", "highlightThickness", "HighlightThickness",
            DEF_CANVAS_HIGHLIGHT_WIDTH, NULL, NULL, 0,
        TKO_SET_PIXELNONEGATIV, &pathMeta, offsetof(TkPathCanvas,
                highlightWidth)},
    {"-insertbackground", "insertBackground", "Foreground",
            DEF_CANVAS_INSERT_BG, NULL, NULL, 0,
        TKO_SET_3DBORDER, &pathMeta, offsetof(TkPathCanvas,
                textInfo.insertBorder)},
    {"-insertborderwidth", "insertBorderWidth", "BorderWidth",
            DEF_CANVAS_INSERT_BD_COLOR, NULL, NULL, 0,
        TKO_SET_PIXELNONEGATIV, &pathMeta, offsetof(TkPathCanvas,
                textInfo.insertBorderWidth)},
    {"-insertofftime", "insertOffTime", "OffTime",
            DEF_CANVAS_INSERT_OFF_TIME, NULL, NULL, 0,
        TKO_SET_INT, &pathMeta, offsetof(TkPathCanvas, insertOffTime)},
    {"-insertontime", "insertOnTime", "OnTime",
            DEF_CANVAS_INSERT_ON_TIME, NULL, NULL, 0,
        TKO_SET_INT, &pathMeta, offsetof(TkPathCanvas, insertOnTime)},
    {"-insertwidth", "insertWidth", "InsertWidth",
            DEF_CANVAS_INSERT_ON_TIME, NULL, NULL, 0,
        TKO_SET_PIXELNONEGATIV, &pathMeta, offsetof(TkPathCanvas,
                textInfo.insertWidth)},
    {"-offset", "offset", "Offset",
            "0,0", NULL, PathMethod_offset, 0,
        0, NULL, 0},
    {"-relief", "relief", "Relief",
            DEF_CANVAS_RELIEF, NULL, NULL, 0,
        TKO_SET_RELIEF, &pathMeta, offsetof(TkPathCanvas, relief)},
    {"-scrollregion", "scrollRegion", "ScrollRegion",
            DEF_CANVAS_SCROLL_REGION, NULL, NULL, 0,
        TKO_SET_SCROLLREGION, &pathMeta, offsetof(TkPathCanvas, scroll)},
    {"-selectbackground", "selectBackground", "Foreground",
            DEF_CANVAS_SELECT_COLOR, NULL, NULL, 0,
        TKO_SET_3DBORDER, &pathMeta, offsetof(TkPathCanvas,
                textInfo.selBorder)},
    {"-selectborderwidth", "selectBorderWidth", "BorderWidth",
            DEF_CANVAS_SELECT_BD_COLOR, NULL, NULL, 0,
        TKO_SET_PIXELNONEGATIV, &pathMeta, offsetof(TkPathCanvas,
                textInfo.selBorderWidth)},
    {"-selectforeground", "selectForeground", "Background",
            DEF_CANVAS_SELECT_FG_COLOR, NULL, NULL, 0,
        TKO_SET_XCOLOR, &pathMeta, offsetof(TkPathCanvas,
                textInfo.selFgColorPtr)},
    {"-state", "state", "State",
            PATH_DEF_STATE, NULL, PathMethod_state, 0,
        0, NULL, 0},
    {"-tagstyle", "", "",
            "expr", NULL, PathMethod_tagstyle, 0,
        0, NULL, 0},
    {"-takefocus", "takeFocus", "TakeFocus",
            DEF_CANVAS_TAKE_FOCUS, NULL, NULL, 0,
        TKO_SET_STRING, NULL, 0},
    {"-width", "width", "Width",
            DEF_CANVAS_WIDTH, NULL, NULL, 0,
        TKO_SET_PIXEL, &pathMeta, offsetof(TkPathCanvas, width)},
    {"-xscrollcommand", "xScrollCommand", "ScrollCommand",
            DEF_CANVAS_X_SCROLL_CMD, NULL, NULL, 0,
        TKO_SET_STRINGNULL, &pathMeta, offsetof(TkPathCanvas, xScrollCmd)},
    {"-xscrollincrement", "xScrollIncrement", "ScrollIncrement",
            DEF_CANVAS_X_SCROLL_INCREMENT, NULL, NULL, 0,
        TKO_SET_PIXEL, &pathMeta, offsetof(TkPathCanvas, xScrollIncrement)},
    {"-yscrollcommand", "yScrollCommand", "ScrollCommand",
            DEF_CANVAS_Y_SCROLL_CMD, NULL, NULL, 0,
        TKO_SET_STRINGNULL, &pathMeta, offsetof(TkPathCanvas, yScrollCmd)},
    {"-yscrollincrement", "yScrollIncrement", "ScrollIncrement",
            DEF_CANVAS_Y_SCROLL_INCREMENT, NULL, NULL, 0,
        TKO_SET_PIXEL, &pathMeta, offsetof(TkPathCanvas, yScrollIncrement)},
