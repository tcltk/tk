...
#ifndef _WIN32
#define __stdcall /* Only valid for Windows */
#endif
...
/* 15 */
EXTERN unsigned		TkWinGetBorderPixels(Tk_Window tkwin,
...
/* 20 */
EXTERN int		TkWinHandleMenuEvent(void *phwnd, unsigned *pMessage,
...
typedef struct TkIntPlatStubs {
    ...
    unsigned (*tkWinGetBorderPixels) (Tk_Window tkwin, Tk_3DBorder border, int which); /* 15 */
    ...
    int (*tkWinHandleMenuEvent) (void *phwnd, unsigned *pMessage, void *pwParam, ptrdiff_t *plParam, ptrdiff_t *plResult); /* 20 */
