...
struct PhotoModel {
    ...
    double density;		/* Image pixels per screen pixel, recorded by
				 * the format that produced the pixels (see
				 * TkImgPhotoSetDensity): the image is laid
				 * out and displayed at width/density by
				 * height/density screen pixels. */
