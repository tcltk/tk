...
#   define TkMacOSXGetRootControl 0
#   define Tk_MacOSXIsAppInFront 0
#   define Tk_MacOSXSetupTkNotifier 0
#   define Tk_MacOSXIsAppInFront 0
#   define Tk_MacOSXSetEmbedHandler 0
#   define Tk_MacOSXTurnOffMenus 0
#   define Tk_MacOSXTkOwnsCursor 0
#   define TkMacOSXInitMenus 0
#   define TkMacOSXInitAppleEvents 0
#   define TkGenWMConfigureEvent 0
