...
/*
 * The following magic values are stored in the "send_event" field of FocusIn
 * and FocusOut events. This allows us to separate "real" events coming from
 * the server from those Tk generates, and from those generated by the
 * [event generate] command.
 * GENERATED_FOCUS_EVENT_MAGIC flags FocusIn/FocusOut events
 *     generated by Tk to move the focus between windows.
 * EVENT_GEN_FOCUS_MAGIC flags a FocusIn/FocusOut event that
 *     was generated by [event generate] at the script level.
 */

#define GENERATED_FOCUS_EVENT_MAGIC	((Bool) 0x547321ac)
#define EVENT_GEN_FOCUS_MAGIC		((Bool) 0xab8cde50)
