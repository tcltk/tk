 ...
 *	from the script level. We are tracking accessible traits per Tk_Window in hash
 *  hash tables that can be accessed on any platform. This core Tk API is backed by
		     ...
		     Tcl_Interp *interp)
{
  ...
  Tcl_CreateObjCommand(interp, "::tk::accessible::acc_help", Tk_SetAccessibleHelp, NULL, NULL);
