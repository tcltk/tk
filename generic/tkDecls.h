...
typedef struct TkStubs {
    ...
    TCL_DEPRECATED_API("MODULE_SCOPE, only for internal use") Tcl_Size (*tkPointToChar) (Tk_TextLayout layout, int x, int y); /* 150 */
...
#define TkPointToChar \
	(tkStubsPtr->tkPointToChar) /* 150 */
