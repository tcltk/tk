...
convertTkFontSlant2CairoFontSlant(enum TkFontSlant slant)
{
    switch(slant) {
	case TK_PATH_TEXT_SLANT_NORMAL: return CAIRO_FONT_SLANT_NORMAL;
	case TK_PATH_TEXT_SLANT_ITALIC: return CAIRO_FONT_SLANT_ITALIC;
	case TK_PATH_TEXT_SLANT_OBLIQUE: return CAIRO_FONT_SLANT_OBLIQUE;
    }
    return CAIRO_FONT_SLANT_NORMAL;
}

static cairo_font_weight_t
convertTkFontWeight2CairoFontWeight(enum TkFontWeight weight)
{
    switch(weight) {
	case TK_PATH_TEXT_WEIGHT_NORMAL: return CAIRO_FONT_WEIGHT_NORMAL;
	case TK_PATH_TEXT_WEIGHT_BOLD: return CAIRO_FONT_WEIGHT_BOLD;
    }
...
int
TkPathGetCurrentPosition(TkPathContext ctx, TkPathPoint *pt)
{
    TkPathContext_ *context = (TkPathContext_ *) ctx;
...
int
TkPathBoundingBox(TkPathContext ctx, TkPathRect *rPtr)
{
    return TCL_ERROR;
}
...
void TkPathPaintLinearGradient(TkPathContext ctx, TkPathRect *bbox,
    TkLinearGradientFill *fillPtr, int fillRule, double fillOpacity,
    TkPathMatrix *mPtr)
{
    TkPathContext_ *context = (TkPathContext_ *) ctx;
    int i;
...
TkPathPaintRadialGradient(TkPathContext ctx, TkPathRect *bbox,
    TkRadialGradientFill *fillPtr, int fillRule, double fillOpacity,
    TkPathMatrix *mPtr)
{
    TkPathContext_ *context = (TkPathContext_ *) ctx;
    int i;
