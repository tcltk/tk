...
foreach {constraint definition fileList} {
    {nt or testwinevent}	{[tcltest::testConstraint nt] || [llength [info commands testwinevent]]}	winDialog
    testutils	{}	testutils.test
    unix	TCLTEST_BUILT_IN	{unixButton.test unixEmbed.test unixMenu.test unixWm.test}
    win		TCLTEST_BUILT_IN	{winButton.test winClipboard.test winFont.test \
